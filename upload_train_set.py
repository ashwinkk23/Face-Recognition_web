...
<div class="row">
<form action="save_data.py" method="post" enctype="multipart/form-data">
<div class="container">
<div class="form-group">
<label for="Newname"><font color="white">Name:</font></label>
<input type ="text" class="form-control" placeholder="Enter Name" name="Newname">
</div>
</div>
<div class="container">
<div class="form-group">
<label for="Newemail"><font color="white">Email:</font></label>
<input type="email" class="form-control" id="email" placeholder="Enter email" name="Newemail">
</div>
</div>
<div class="container">
<div class="col-md-6">
<input type="file" class="btn-info" id="images" name="images_" onchange="preview_images();" multiple>
</div>
</div>
<div class="container">
<div class="col-md-6">
